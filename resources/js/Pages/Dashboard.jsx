            ...
            <div className="py-20">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col justify-center items-center text-center">
                        <span className="font-mono font-bold text-2xl mt-32">แนะนำโต๊ะ</span>
                        <p className="mt-4">โต๊ะชาบูที่ออกแบบให้เหมาะกับจำนวนคนที่นั่งและรูปแบบหม้อชาบู โดยคำนึงถึงพื้นที่การใช้งาน ความสะดวกสบาย และระบบระบายความร้อนของเตา</p>

                    </div>
                    <div className="flex flex-col md:flex-row gap-8 justify-center mt-10 mb-10">
                        <img
